...
export default class axes implements expresion {
    ...
    constructor(tipe, axe: string, id, linea, columna) {
        this.tipe = tipe
    ...
    ancestor3D(ent: Array<entorno>, c3d: nodo3d, pos_param: number) {
    ...
    atr3D(ent: Array<entorno>, c3d: nodo3d, pos_param: number) {
    ...
    child3D(ent: Array<entorno>, c3d: nodo3d, pos_param: number) {
